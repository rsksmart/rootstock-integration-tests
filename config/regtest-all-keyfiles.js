            ...
            members: [
                {
                    ...
                    customConfig: {
                        ...
                        'federator.signers.BTC.path': path.resolve(
                            __dirname,
                            `${keysPathResolve}/genesis-federation/fed1.key`
                        ),
                        'federator.signers.RSK.type': 'keyFile',
                        'federator.signers.RSK.path': path.resolve(
                            __dirname,
                            `${keysPathResolve}/genesis-federation/fed1.key`
                        ),
                        'federator.signers.MST.type': 'keyFile',
                        'federator.signers.MST.path': path.resolve(
                            __dirname,
                            `${keysPathResolve}/genesis-federation/fed1.key`
                        ),
                        ...
                        'peer.active.2.nodeId':
                            '328105ab6744914e61bcfcb729d741f23528fd6eb1b42628120ab027d82c9c2d8c445f8c6727e291e1abcaa8398bf47d4cca6ea6600b137b875b8df22251e325',
                ...
                },
                {
                    ...
                    customConfig: {
                        ...
                        'federator.signers.BTC.path': path.resolve(
                            __dirname,
                            `${keysPathResolve}/genesis-federation/fed2.key`
                        ),
                        'federator.signers.RSK.type': 'keyFile',
                        'federator.signers.RSK.path': path.resolve(
                            __dirname,
                ...
                },
                {
                    ...
                    customConfig: {
                        ...
                        'federator.signers.BTC.path': path.resolve(
                            __dirname,
                            `${keysPathResolve}/genesis-federation/fed3.key`
                        ),
                        'federator.signers.RSK.type': 'keyFile',
                        'federator.signers.RSK.path': path.resolve(
                            __dirname,
            ...
            members: [
                {
                    ...
                    customConfig: {
                        ...
                        'federator.signers.BTC.path': path.resolve(
                            __dirname,
                            `${keysPathResolve}/second-federation/fed1.key`
                        ),
                        'federator.signers.RSK.type': 'keyFile',
                        'federator.signers.RSK.path': path.resolve(
                            __dirname,
                        ...
                        'peer.active.1.nodeId':
                            '8ac219dc7ac6bfe401892ddd26c63f14e7cd5b62c750162c0889eee19c1725c29e52c00bc91ee260241d2e4ddcf72ed69746b226fc7c1c63f906d19a7a31988a',

                        'peer.active.2.ip': '127.0.0.1',
                        'peer.active.2.port': 40004,
                        'peer.active.2.nodeId':
                            '5ba2b832b97cfba1626eb264bd1ec2733a7ca02602153c57c0c95c9700030dccb0edb612fd01bd806c0202aa3380fb8dcbeddb7a1386259d4b9679c0003d04bc',

                        'peer.active.3.ip': '127.0.0.1',
                        'peer.active.3.port': 50000,
                        'peer.active.3.nodeId':
                            '4ba6ec42eab139697c3614653e130e76fc15d1d7e5c91b3df63d3c06195d42265a5550cda65aa54de279a79a55e5513598b183e64f351e790d6370a6c67b141d',
                ...
                },
                {
                    ...
                    customConfig: {
                        ...
                        'federator.signers.BTC.path': path.resolve(
                            __dirname,
                            `${keysPathResolve}/second-federation/fed2.key`
                        ),
                        'federator.signers.RSK.type': 'keyFile',
                        'federator.signers.RSK.path': path.resolve(
                            __dirname,
                ...
                },
                {
                    ...
                    customConfig: {
                        ...
                        'federator.signers.BTC.path': path.resolve(
                            __dirname,
                            `${keysPathResolve}/second-federation/fed3.key`
                        ),
                        'federator.signers.RSK.type': 'keyFile',
                        'federator.signers.RSK.path': path.resolve(
                            __dirname,
            ...
            members: [
                {
                    ...
                    customConfig: {
                        ...
                        'federator.signers.BTC.path': path.resolve(
                            __dirname,
                            `${keysPathResolve}/third-federation/fed1.key`
                        ),
                        'federator.signers.RSK.type': 'keyFile',
                        'federator.signers.RSK.path': path.resolve(
                            __dirname,
                        ...
                        'peer.active.1.nodeId':
                            '0b1d25b03d041028326ac5b27af941524c31bf09df5fece7476d3940f9cd2394d3cd349b9b265b7427607736dcee323d9e4a893b1d15549c928278a4e6012c08',

                        'peer.active.2.ip': '127.0.0.1',
                        'peer.active.2.port': 50004,
                        'peer.active.2.nodeId':
                            '501878fb22fdf374921d168bb1ea02b324f00eb2c7610cb452167a9dcdab01646d8c1f285b44074c45255fc693f19486819256ef98a9be8b62e4e9af4b54542c',

                        'peer.active.3.ip': '127.0.0.1',
                        'peer.active.3.port': 60000,
                        'peer.active.3.nodeId':
                            '3ebf25b39fa357d14afd8cf2a66207e7c2eba9e0e21d96d3026f62e2451724d28e2800a5c024e62e6edad2073fc1670df7e7e7c157436c53e73bb72f1d58f88d',

                        'peer.active.4.ip': '127.0.0.1',
                        'peer.active.4.port': 60002,
                        'peer.active.4.nodeId':
                            'c60bb95e83a68a68fb090eef7e2b11d463eb7496a4f93ec35874debe97068020e0b40997586fc982d7423c0f376d0ba9a5d4ed058e51822118a88fb6f1746ea6',

                        'peer.active.5.ip': '127.0.0.1',
                        'peer.active.5.port': 60004,
                        'peer.active.5.nodeId':
                            'b7d5a2e6341e38cb1c6fe795ddcaefa6bf5de6e4f33dddb14688863edd465d5dbd42e333297ff310125011c16ec58a684137bd47bd9ee3548507d045cc49c8e7',
                ...
                },
                {
                    ...
                    customConfig: {
                        ...
                        'federator.signers.BTC.path': path.resolve(
                            __dirname,
                            `${keysPathResolve}/third-federation/fed2.key`
                        ),
                        'federator.signers.RSK.type': 'keyFile',
                        'federator.signers.RSK.path': path.resolve(
                            __dirname,
                ...
                },
                {
                    ...
                    customConfig: {
                        ...
                        'federator.signers.BTC.path': path.resolve(
                            __dirname,
                            `${keysPathResolve}/third-federation/fed3.key`
                        ),
                        'federator.signers.RSK.type': 'keyFile',
                        'federator.signers.RSK.path': path.resolve(
                            __dirname,
            ...
            members: [
                {
                    ...
                    customConfig: {
                        ...
                        'federator.signers.BTC.path': path.resolve(
                            __dirname,
                            `${keysPathResolve}/fourth-federation/fed1.key`
                        ),
                        'federator.signers.RSK.type': 'keyFile',
                        'federator.signers.RSK.path': path.resolve(
                            __dirname,
                        ...
                        'peer.active.3.ip': '127.0.0.1',
                        'peer.active.3.port': 60002,
                        'peer.active.3.nodeId':
                            'c60bb95e83a68a68fb090eef7e2b11d463eb7496a4f93ec35874debe97068020e0b40997586fc982d7423c0f376d0ba9a5d4ed058e51822118a88fb6f1746ea6',

                        'peer.active.4.ip': '127.0.0.1',
                        'peer.active.4.port': 60004,
                        'peer.active.4.nodeId':
                            'b7d5a2e6341e38cb1c6fe795ddcaefa6bf5de6e4f33dddb14688863edd465d5dbd42e333297ff310125011c16ec58a684137bd47bd9ee3548507d045cc49c8e7',
                ...
                },
                {
                    ...
                    customConfig: {
                        ...
                        'federator.signers.BTC.path': path.resolve(
                            __dirname,
                            `${keysPathResolve}/fourth-federation/fed2.key`
                        ),
                        'federator.signers.RSK.type': 'keyFile',
                        'federator.signers.RSK.path': path.resolve(
                            __dirname,
                ...
                },
                {
                    ...
                    publicKeys: {
                        btc: '0x03b7d5a2e6341e38cb1c6fe795ddcaefa6bf5de6e4f33dddb14688863edd465d5d',
                        rsk: '0x03b7d5a2e6341e38cb1c6fe795ddcaefa6bf5de6e4f33dddb14688863edd465d5d',
                        mst: '0x03b7d5a2e6341e38cb1c6fe795ddcaefa6bf5de6e4f33dddb14688863edd465d5d',
                    },
                    customConfig: {
                        'federator.signers.BTC.type': 'keyFile',
                        'federator.signers.BTC.path': path.resolve(
                            __dirname,
                            `${keysPathResolve}/fourth-federation/fed3.key`
                        ),
                        'federator.signers.RSK.type': 'keyFile',
                        'federator.signers.RSK.path': path.resolve(
                            __dirname,
                    ...
                    port: 60004,
                    rpcPort: 60005,
                    nodeId: 'b7d5a2e6341e38cb1c6fe795ddcaefa6bf5de6e4f33dddb14688863edd465d5dbd42e333297ff310125011c16ec58a684137bd47bd9ee3548507d045cc49c8e7',
                },
            ],
        },
    },
