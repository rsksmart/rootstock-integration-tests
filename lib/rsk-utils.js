 ...
 * @param {number} fromBlockNumber optional. If not provided, it will start searching from the latest block number provided by the `rskTxHelper.getBlockNumber()`
 * @param {number} toBlockNumber optional. If provided, needs to be greater than `fromBlockNumber`
...
const findEventInBlock = async (
    ...
    const {startBlock, endBlock} = getValidBlockRange(currentBlockNumber, fromBlockNumber, toBlockNumber);
 ...
 * @param {number} toBlockNumber
 * @returns {{startBlock: number, endBlock: number}}
 */
const getValidBlockRange = (currentBlockNumber, fromBlockNumber, toBlockNumber) => {
 ...
 */
const getEventsInBlockRange = async (
    rskTxHelper,
    fromBlockNumber,
    toBlockNumber
) => {
