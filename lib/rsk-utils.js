...
const findEventInBlock = async (
    ...
    const {startBlock, endBlock} = await getValidBlockRange(rskTxHelper, fromBlockHashOrBlockNumber, toBlockHashOrBlockNumber);
...
/**
 * Gets the block range from `fromBlockHashOrBlockNumber` to `toBlockHashOrBlockNumber`.
 * @param {RskTransactionHelper} rskTxHelper to make transactions to the rsk network
 ...
 */
const getValidBlockRange = async (rskTxHelper, fromBlockHashOrBlockNumber, toBlockHashOrBlockNumber) => {
    ...
    if (fromBlockHashOrBlockNumber > toBlockHashOrBlockNumber) {
        throw new Error(
            `fromBlockHashOrBlockNumber: ${fromBlockHashOrBlockNumber} is greater than toBlockHashOrBlockNumber: ${toBlockHashOrBlockNumber}`
        );
    }

    return { startBlock: fromBlockHashOrBlockNumber, endBlock: toBlockHashOrBlockNumber };
};
