...
const decodeLogs = (rskClient, txReceipt, contractAbis) => {
  const eventSignatureMap = buildEventSignatureMap(rskClient, abis);
  const events = [];
...
const buildEventSignatureMap = (rskClient, contractAbis) => {
  return contractAbis
    .flat()
