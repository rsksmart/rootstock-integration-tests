...
const setFeePerKb = async (rskTxHelper, feePerKbInSatoshis) => {
  ...
  await rskTxHelper.getClient().eth.personal.importRawKey(FEE_PER_KB_CHANGE_PK, '');
  await rskTxHelper.getClient().eth.personal.unlockAccount(FEE_PER_KB_CHANGE_ADDR, '');
