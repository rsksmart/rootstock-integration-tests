...
describe('2wp tests', () => {
  ...
  describe('Pegin legacy successful tests', () => {
  ...
  describe('Pegin v1 successful tests', () => {
  ...
  describe('Pegins legacy rejected tests', () => {
  ...
  describe('Pegin v1 rejected tests', () => {

    it('should reject and refund pegin v1 with multiple OP_RETURN outputs for RSK with value exactly minimum', async () => {
    ...
    it('should reject and refund pegin v1 with OP_RETURN output to RSK with invalid payload with value exactly minimum', async () => {
    ...
    it('should reject and refund pegin v1 with invalid pegin v1 version with value exactly minimum', async () => {
  ...
  describe('Pegout successful tests', () => {
