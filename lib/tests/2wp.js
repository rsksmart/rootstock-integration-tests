...
const getReleaseRequestRejectedEventFromContractCallTxReceipt = (
    ...
    const releaseRequestRejectedEvent = bridgeTxParser
        .decodeLogs(contractCallTxReceipt)
        .find((event) => event.signature === PEGOUT_EVENTS.RELEASE_REQUEST_REJECTED.signature);
    return {
