        ...
        if (fullExecution) {
            ...
            it('should reject and not refund a pegout when a contract is trying to execute it', async () => {
                ...
                const actualReleaseRequestRejectedEvent =
                    getReleaseRequestRejectedEventFromContractCallTxReceipt(contractCallTxReceipt);
...
const getReleaseRequestRejectedEventFromContractCallTxReceipt = (contractCallTxReceipt) => {
    ...
    const releaseRequestRejectedAbiElement =
        bridgeTxParser.jsonInterfaceMap[PEGOUT_EVENTS.RELEASE_REQUEST_REJECTED.signature];
