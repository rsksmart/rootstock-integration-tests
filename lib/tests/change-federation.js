...
const { parseRLPToPegoutWaitingSignatures, parseU } = require('@rsksmart/bridge-state-data-parser/pegout-waiting-signature');
...
const execute = (description, newFederationConfig, makeDonationPegins = false) => {
    ...
    describe(description, async function() {
        ...
        it('should migrate utxos', async () => {
            ...
            await retryWithCheck(method, pegoutIsBroadcasted => pegoutIsBroadcasted);
